...
- `/forge-init` -> `.forge/skills/forge-init/SKILL.md`
- `/forge-ask` -> `.forge/skills/forge-ask/SKILL.md`
- `/forge-plan` -> `.forge/skills/forge-plan/SKILL.md`
- `/forge-implementation` -> `.forge/skills/forge-implementation/SKILL.md`
- `/forge-execute` -> `.forge/skills/forge-execute/SKILL.md`
- `/forge-review` -> `.forge/skills/forge-review/SKILL.md`
