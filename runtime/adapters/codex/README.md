...
Codex uses `AGENTS.md` as the repository-native Forge entrypoint. Codex is skills-first for Forge usage: prompts and command-like invocations resolve to shared skills under `runtime/skills/*/SKILL.md`.
