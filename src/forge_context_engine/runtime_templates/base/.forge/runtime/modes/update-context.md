...
10. Report changed files, remaining unknowns, and the next action.
...
- Do not read `.forge/generated/` by default.
...
- If legacy or archived context is useful but not confirmed in current code, mark it as legacy-derived or needing confirmation.
